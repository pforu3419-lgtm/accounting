...
export default function FAQSection() {
  const faqs = [
    ...
    { id: "faq-7", question: "ติดต่อสอบถามได้อย่างไร?", answer: "โทร 02-754-0992-3, 02-754-0325 มือถือ 081-611-6174, Line 0888137777 จันทร์–ศุกร์ 09:00–18:00 หรือกดปุ่มปรึกษาฟรีด้านล่าง" },
